...
import Config from '../../../config/site/navigation.config?codeblock'
...
[View component source code](https://github.com/cerner/terra-core/tree/master/packages/action-header)
