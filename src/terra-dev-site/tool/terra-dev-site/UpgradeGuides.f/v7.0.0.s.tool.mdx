...
|`navConfig.navigation.primaryNavigationItems.text`|`primaryNavigationItems.text`|unchanged.|
...
More information abut dev-site config can be found on our [config page](/dev_tools/cerner-terra-dev-site/terra-dev-site/configuration).
...
Terra-toolkit is no longer a peer dependency.
